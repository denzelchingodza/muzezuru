...
- **Fine-tuning method:** [QLoRA](https://arxiv.org/abs/2305.14314) — 4-bit quantization of the frozen base model + trainable LoRA adapters (rank 16, alpha 32, applied to all linear layers) — the only way to fine-tune a multi-billion-parameter model on a single free GPU.
